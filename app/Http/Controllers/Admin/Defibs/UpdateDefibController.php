...
final class UpdateDefibController extends Controller
{
    public function __invoke(Request $request, Defib $defib): RedirectResponse
    {
        ...
        $defib->update($validated);

        return redirect()
            ->route('admin.defibs.show', $defib)
            ->with('success', 'Defib updated successfully.');
    }
}

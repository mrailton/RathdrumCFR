                            ...
                            <div class="border rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                                    ...
                                    <label class="flex items-center gap-2 text-sm">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" data-group="{{ $group }}" {{ in_array($permission->name, old('permissions', $rolePermissions)) ? 'checked' : '' }} class="permission-checkbox h-4 w-4 rounded border-gray-300 text-red-600 focus:ring-red-500">
